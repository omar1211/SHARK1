...
ZelzalChecler_cmd = (
    "𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊 - اوامـر الصيـد والتشيكـر](t.me/L_H_V) 𓆪\n\n"
...
@jepiq.zed_cmd(pattern="الصيد")
async def cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalChecler_cmd)


@jepiq.zed_cmd(pattern="صيد (.*)")
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    ...
                    caption="ᯓ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊َِ  - صيـد القرش 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n**•────────────────────•**\n- By ❲ @L_H_V ❳ ".format(
                ...
                await event.client.send_file(
                    ch,
                    "https://t.me/CU_VC/7000",
                    caption="ᯓ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊 - صيـد القرش 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n**•────────────────────•**\n- By ❲ @L_H_V ❳ ".format(
                        username, trys, choice
                    ),
                )
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await jepiq(
                functions.channels.CreateChannelRequest(
                    title="⎉ تثبيت القرش 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊 ⎉",
                    about="This channel to hunt username by - @L_H_V ",
                )
            )
            ch = ch.updates[1].channel_id
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    ch,
                    "https://t.me/CU_VC/7000",
                    caption="ᯓ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊 َِ - صيـد القرش 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Save: ❲ Chaneel ❳\n**•────────────────────•**\n- By ❲ @L_H_V ❳ ".format(
                        username, trys2
                    ),
                )
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/CU_VC/7000",
                    caption="ᯓ 𓏺𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊 - صيـد القرش 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Save: ❲ Chaneel ❳\n**•────────────────────•**\n- By ❲ @L_H_V ❳ ".format(
                        username, trys2
                    ),
                )
                await event.client.send_message(
...
@jepiq.zed_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@jepiq.zed_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
...
@jepiq.zed_cmd(pattern="حاله الصيد")
async def _(event):
    if "on" in isclaim:
        await event.edit(f"**- الصيد وصل لـ({trys2[0]}) من المحاولات**")
    elif "off" in isclaim:
...
@jepiq.zed_cmd(pattern="حاله التثبيت")
async def _(event):
    if "on" in isauto:
        await event.edit(f"**- التثبيت وصل لـ({trys2[0]}) من المحاولات**")
    elif "off" in isauto:
...
@jepiq.zed_cmd(pattern="ايقاف الصيد")
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@jepiq.zed_cmd(pattern="ايقاف التثبيت")
async def _(event):
    if "on" in isauto:
        isauto.clear()
        isauto.append("off")
