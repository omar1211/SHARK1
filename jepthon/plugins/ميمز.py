...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="𓆜︙ BY : @L_H_V 🎀",parse_mode="html")
  await vois.delete()
...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="𓆜︙ BY : @L_H_V 🤲🏻☪️",parse_mode="html")
  await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="ثيم$"))
async def jepThe(theme):
  rl = random.randint(2,510)
  url = f"https://t.me/GSSSD/{rl}"
  await theme.client.send_file(theme.chat_id,url,caption="𓆜︙ THEME BY : @L_H_V 🎊",parse_mode="html")
  await theme.delete()
