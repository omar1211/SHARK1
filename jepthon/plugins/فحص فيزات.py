...
""" 
CC Checker & Generator for jepthon™ t.me/ZedThon
...
@jepiq.zed_cmd(pattern="cc(?:\s|$)([\s\S]*)")
...
# code by t.me/zzzzl1l
@jepiq.zed_cmd(pattern="كومبو(?:\s|$)([\s\S]*)")
...
# code by t.me/zzzzl1l
@jepiq.zed_cmd(pattern="توليد(?:\s|$)([\s\S]*)")
async def song2(event):
    been = event.pattern_match.group(1)
    chat = "@SDBB_Bot" # code by t.me/zzzzl1l
    reply_id_ = await reply_id(event)
...
# code by t.me/zzzzl1l
@jepiq.zed_cmd(pattern="فيزا(?:\s|$)([\s\S]*)")
async def song2(event):
...
# code by t.me/zzzzl1l
@jepiq.zed_cmd(pattern="ماستر(?:\s|$)([\s\S]*)")
async def song2(event):
...
# code by t.me/zzzzl1l
@jepiq.zed_cmd(pattern="اماكس(?:\s|$)([\s\S]*)")
async def song2(event):
